    ...
    <motion.div ref={ref} className={cn('relative w-full max-w-4xl mx-auto h-full', className)}>
      <div className="absolute -left-4 md:-left-20 top-3">
        <motion.div
          ...
          animate={{
            boxShadow:
              scrollYProgress.get() > 0 ? 'none' : '0 0 16px rgba(0,232,150,0.4)',
          }}
          className="ml-[27px] h-4 w-4 rounded-full border border-mint/30 flex items-center justify-center"
        >
          <motion.div
            transition={{ duration: 0.2, delay: 0.5 }}
            animate={{
              backgroundColor: scrollYProgress.get() > 0 ? '#1E3055' : '#00E896',
            }}
        ...
        >
          ...
          <defs>
            <motion.linearGradient
              ...
              y2={y2}
            >
              <stop stopColor="#00E896" stopOpacity="0" />
              <stop stopColor="#00E896" />
              <stop offset="0.5" stopColor="#3D8BFF" />
